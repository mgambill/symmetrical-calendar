...
export const useProfileStore = defineStore('profile', () => {
  const defaultProfiles: Profile[] = [
    ...
    { id: 2, name: 'Steve Rogers', alias: 'Captain America', organizations: [2], roles: [UserRole.User] },
    { id: 3, name: 'Peter Quill', alias: 'Star-Lord', organizations: [3], roles: [UserRole.User] },
    { id: 4, name: 'Susan Storm', alias: 'Invisible Woman', organizations: [4], roles: [UserRole.PatientImport, UserRole.PatientReader] },
    { id: 5, name: 'Peter Parker', alias: 'Spider-Man', organizations: [1, 2], roles: [UserRole.User] }
  ]
